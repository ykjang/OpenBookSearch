...
- 공통코드 
  ...
  | 코드 | 유형 | 메세지                                                       |
  | ---- | ---- | ------------------------------------------------------------ |
  | S001 | 성공 | 정상적으로 처리되었습니다.                                   |
  | E001 | 에러 | 요청항목이 유효하지 않습니다.                                |
  | E002 | 에러 | 지원하지 않는 메서드입니다.                                  |
  | E101 | 에러 | 회원아이디가 이미 존재합니다.                                |
  | E102 | 에러 | 회원아이디가 존재하지 않습니다.                                       |
  | E103 | 에러 | 비밀번호가 틀렸습니다.                                       |
  | E201 | 에러 | 책검색 API 호출에 실패했습니다.                              |
  | E900 | 에러 | 서비스처리 도중 오류가 발생했습니다.계속 발생시 관리자에게 문의하시기 바랍니다. |
